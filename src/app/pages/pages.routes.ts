...
const pagesRoutes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'lista_enfermeras', component: NursesComponent, data: {titulo: 'Enfermeras', subtitle: 'Bienvenido'}},
      ...
      { path: 'listar_pisos', component: ListFloorsComponent, data: {titulo: 'Pisos', subtitle: 'Bienvenido'}},
      { path: 'listar_pacientes', component: ListPatientsComponent, data: {titulo: 'Pacientes', subtitle: 'Bienvenido'}},
